...
public class StockController extends IController {
	...
	public Map<String, Object> FinStockList(@RequestBody HashMap<String, Object> data, HttpServletRequest request) {
		return stockSetupService.FindStockList(data,getUser(request));
