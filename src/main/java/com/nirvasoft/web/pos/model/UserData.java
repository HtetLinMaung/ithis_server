...
public class UserData {
	...
	private String name;
	private String u12Syskey;
	private String locroleSyskey;
	private String locrolestatus;
	...
	public String getU12Syskey() {
		return u12Syskey;
	}

	public void setU12Syskey(String u12Syskey) {
		this.u12Syskey = u12Syskey;
	}
	public String getLocroleSyskey() {
		return locroleSyskey;
	}

	public void setLocroleSyskey(String locroleSyskey) {
		this.locroleSyskey = locroleSyskey;
	}
	public String getLocrolestatus() {
		return locrolestatus;
	}

	public void setLocrolestatus(String locrolestatus) {
		this.locrolestatus = locrolestatus;
	}
	...
	protected void clearProperties() {
		...
		this.u12Syskey = "";
		this.password = "";
		this.locroleSyskey="0";
		this.locrolestatus="0";
	}
